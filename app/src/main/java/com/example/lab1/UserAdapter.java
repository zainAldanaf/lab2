...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    private List<com.example.lab1.User> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;
    private ItemClickListener2 itemClickListener2;


    UserAdapter(Context context, List<com.example.lab1.User> data, ItemClickListener onClick, ItemClickListener2 onClick2) {
    ...
    com.example.lab1.User getItem(int id) {
        return mData.get(id);
    }
